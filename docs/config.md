...
|Type|The event type.  Use this to determine what other data will be included.  See: [Events.cs](https://github.com/sredevopsorg/slskd/blob/main/src/slskd/Events/Types/Events.cs).|
